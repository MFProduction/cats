...
class FuneralsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funeral" do
    assert_difference('Funeral.count') do
      post funerals_url, params: { funeral: { cat_name: @funeral.cat_name, end_time: @funeral.end_time, start_time: @funeral.start_time } }
    end
  ...
  test "should update funeral" do
    patch funeral_url(@funeral), params: { funeral: { cat_name: @funeral.cat_name, end_time: @funeral.end_time, start_time: @funeral.start_time } }
